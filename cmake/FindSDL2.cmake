...
if(WIN32)
	if("${CMAKE_SIZEOF_VOID_P}" STREQUAL "8")
		find_library(SDL2_LIBRARY_TEMP "SDL2" PATH_SUFFIXES lib/x64 PATHS ${SDL2_ROOT_DIR})
		find_file(SDL2_DYLIB "SDL2.dll" PATH_SUFFIXES lib/x64 PATHS ${SDL2_ROOT_DIR})
	else()
	...
	find_library(SDL2_LIBRARY_TEMP "SDL2" PATH_SUFFIXES lib/x86 lib/x64 PATHS ${SDL2_ROOT_DIR})
endif()
